...
import { Save, Search, CalendarDays, Users, DollarSign, Clock, Building, Banknote, UserCircle, FileText, Trash2, AlertTriangle, ListChecks, Download, X, Sparkles, Copy, Loader2, MapPin } from 'lucide-react';

// Firebase 구성 (실제 값은 환경에 따라 제공됨)
const firebaseConfig = {
  apiKey: "AIzaSyA0SDesn1M2xjLrUjxIUmG9QD0T88zH2o4",
  authDomain: "church-parking-app.firebaseapp.com",
  projectId: "church-parking-app",
  storageBucket: "church-parking-app.firebasestorage.app",
  messagingSenderId: "105822938443",
  appId: "1:105822938443:web:eb87b880af38f6143674ce",
};

const appId = typeof window.__app_id !== 'undefined' ? window.__app_id : 'default-church-parking-app';
